...
//open file from data directory
	use ../data/ibu-aki-periOp.dta
************************************************************************	
** ATT
************************************************************************		

// View Post-Op variable
	tab periOp periOp_bin, missing
...
// Set up excel sheet
	putexcel set ../results/ibu-aki-periOp-bin-ATT.xlsx, replace
...
//Fit interaction model
	poisson kEver i.periOp_bin##i.pain [pweight = ATTwts], exposure(pTime1000) irr
