* ==============================================================================
* IBU Opioid AKI effect of IBU on AKI by ICU Status
* ==============================================================================
//Base settings
	clear
	set more off
...
//open file from data directory
	use ../data/ibu-aki-icuCurrent.dta
	
************************************************************************	
** ATT
************************************************************************		
// View Post-Op variable
	tab icuCurrent, missing
...
// Set up excel sheet
	putexcel set ../results/ibu-aki-icuCurrent-ATT.xlsx, replace
...
//Fit interaction model
	poisson kEver i.icuCurrent_cat##i.pain [pweight = ATTwts], exposure(pTime1000) irr
