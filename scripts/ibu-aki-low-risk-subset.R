...
# Create dummy column for compatibility with existing balance plot function
data.dummy.ones <- data %>% #Required for bal.plots function;it will generate duplicate plots
  mutate(dummy.ones =1)
