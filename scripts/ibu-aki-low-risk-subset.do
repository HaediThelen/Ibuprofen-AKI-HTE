* ==============================================================================
*  IBU-AKI Overall effect of IBU on AKI in the Low-Risk Subset
* ==============================================================================
//Base settings
	clear
	set more off
...
// Set up excel
	putexcel set ../results/ibu-aki-low-risk-subset.xlsx, replace
...
// Set up excel
	putexcel set ../results/ibu-aki-low-risk-subset-kStage23.xlsx, replace
		putexcel A1 = "Effect Modifier" B1 = "Oxycodone" C1 ="LB" D1= "UB" ///
				E1 = "Ibuprofen" F1= "LB" G1 = "UB" 						///
				H1= "Rate Difference" I1="LB" J1= "UB"						///	
				K1= "IRR" L1 = "LB" M1 = "UB"				
...
// Set up excel
	putexcel set ../results/ibu-aki-low-risk-subset-rrt.xlsx, replace
		putexcel A1 = "Effect Modifier" B1 = "Oxycodone" C1 ="LB" D1= "UB" ///
				E1 = "Ibuprofen" F1= "LB" G1 = "UB" 						///
				H1= "Rate Difference" I1="LB" J1= "UB"						///	
				K1= "IRR" L1 = "LB" M1 = "UB"				
