* ==============================================================================
* IBU Opioid AKI effect of IBU on AKI by any nephrotoxin 
* ==============================================================================
//Base settings
	clear
	set more off
...
********************************************************************************	
//open file
	use ../data/ibu-aki-anyNtx.dta
************************************************************************	
** ATT
************************************************************************		

// View Post-Op variable
	tab anyNtx anyNtx_cat, missing
...
// Set up excel sheet
	putexcel set ../results/ibu-aki-anyNtx-ATT.xlsx, replace
		...
		putexcel A2 = "No Ntx" A3 = "Ntx"
	
//Fit interaction model
	poisson kEver i.anyNtx_cat##i.pain [pweight = ATTwts], exposure(pTime1000) irr
...
// Multiplicative Interaction
	// Estimate the IRR for each level of periOp
		lincom 1.pain + 2.anyNtx_cat#1.pain, eform
...
// Additive Interaction
	// Effects of pain at each bmi level
		margins r.pain@anyNtx_cat, predict(ir)
			matrix result = r(table)
	...
	// IR in each of the 2 groups (for 2x2 table)
		margins pain#anyNtx_cat, predict(ir)
			matrix result = r(table)
	...
	// Difference in difference estimate
		margins pain#i.anyNtx_cat, predict(ir) contrast(effects)
			matrix result = r(table)
